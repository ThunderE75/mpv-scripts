...
function contains_item(l, i)
   for k, v in pairs(l) do
      if v == i then
         mp.osd_message("shredding cancelled")
         l[k] = nil
         return true
      end
   end
   mp.osd_message("shredding file at the end")
   return false
end
...
--mp.add_key_binding("ctrl+DEL", "shred_file", mark_delete)
mp.add_key_binding("DEL", "shred_file", mark_delete)
