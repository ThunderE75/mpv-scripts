...
local user_opts = {
    ...
    speed_font_size = 14,                  -- speed button font size
    ...
    seekbarfg_color = "#32b4ff",           -- color of the seekbar progress
    seekbarbg_color = "#32b4ffaf",           -- color of the remaining seekbar
    seek_handle_color = "#000000",         -- color of the seekbar handle
    seek_handle_border_color = "#32b4ff",  -- inner border color drawn inside the seekbar handle (set to "disable" to disable)
    ...
    hover_effect_color = "#32b4ff",        -- color of a hovered button when hover_effect includes "color"
    ...
    nibble_color = "#32ff98",              -- color of chapter nibbles on the seekbar
    nibble_current_color = "#FFFFFF",      -- color of the current chapter nibble on the seekbar
    ab_loop_color = "#ee5d24",             -- color of the A/B loop range on the seekbar
